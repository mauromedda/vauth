module github.com/mauromedda/vauth

go 1.12

replace github.com/mauromedda/vauth/command/token => ./command/token
...
require (
	...
	github.com/hashicorp/nomad/api v0.0.0-20190501032619-c06daf2d8a94 // indirect
